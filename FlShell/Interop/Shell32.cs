...
namespace FlShell.Interop
{
    ...
    #region "       W32Find_Data"
    ///<summary>
    ///W32Find_Data is a Class representation of the Win32_Find_Data struct. It should be an exact replacement for
    ///that struct, but, for some reason, which I do not care to explore, is not.
    ...
    ///</summary>
    ///<remarks></remarks>
    [StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Auto), BestFitMapping(false)]
    public class W32Find_Data
    {
        ...
        {
            get { return this.dwFileAttributes; }
            set
            { //(ByVal value As FileAttribute)
                dwFileAttributes = value;
            }
        }
        ...
        public bool IsCompressed
        {
            get
            {
                return ((this.dwFileAttributes & FileAttributes.Compressed) == FileAttributes.Compressed);
            }
        }
        ...
        public bool IsEncrypted
        {
            get
            {
                return ((this.dwFileAttributes & FileAttributes.Encrypted) == FileAttributes.Encrypted);
            }
        }
        ...
        public long Length
        {
            get
            {
                return (Convert.ToInt64(nFileSizeHigh) << 0x00020) | (nFileSizeLow & Convert.ToInt64(0x000FFFFFFFF));
            }
        }
        ...
        public DateTime CreationTimeUTC
        {
            get
            {
                long filetime = ((Convert.ToInt64(ftCreationTimeHigh) << 0x00020) | ftCreationTimeLow);
        ...
        public DateTime LastWriteTimeUTC
        {
            get
            {
                long filetime = ((Convert.ToInt64(ftLastWriteTimeHigh) << 0x00020) | ftLastWriteTimeLow);
                return DateTime.FromFileTimeUtc(filetime);
            }
        }
        ...
        public DateTime LastAccessTimeUTC
        {
            get
            {
                long filetime = ((Convert.ToInt64(ftLastAccessTimeHigh) << 0x00020) | ftLastAccessTimeLow);
                return DateTime.FromFileTimeUtc(filetime);
            }
        }
        ...
        public string DirectoryName
        {
            get
            {
                if (m_directoryname == null || m_directoryname == string.Empty)
                    return "";
                else
    ...
    public partial class Shell32
    {
        ...
        public struct POINT
        {
            void New(int xValue, int yValue)
            {
                x = xValue;
                y = yValue;
            }
        ...
        */
        ...
        int iImageList, ref Guid riid, ref IntPtr handle);
