...
namespace FlShell
{
    ...
    public partial class PlacesToolbar : UserControl
    {
        ...
        public void CreateDefaultItems()
        {
            ...
            // FAB 29/06/2016
            Add(new ShellItem(Environment.SpecialFolder.MyDocuments));
            Add(new ShellItem(Environment.SpecialFolder.MyMusic));
            Add(new ShellItem(Environment.SpecialFolder.MyPictures));
            Add(new ShellItem(Environment.SpecialFolder.MyVideos));
        ...
        // raccourci vers le répertoire des chansons
        private ShellItem m_songsfolder;// = new ShellItem(Environment.SpecialFolder.MyMusic);

        
        public ShellItem songsFolder
        {
            get { return m_songsfolder; }
            set {
                try
                {
                    m_songsfolder = value;
